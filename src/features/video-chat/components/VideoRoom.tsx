...
/**
 * VideoRoom component for the video chat feature
 * Handles WebRTC connections and video/audio streams
 */
export default function VideoRoom({ roomId }: VideoRoomProps) {
  ...
  /**
   * Stop webcam stream and clean up resources
   */
  const stopWebcam = () => {
  ...
  /**
   * Start webcam with fallback options if primary options fail
   */
