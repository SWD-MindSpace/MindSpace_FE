...
import { AppointmentNotes } from '../schemas/AppointmentNote';
            ...
            try {
                ...
                if (existingNotes) {
                    ...
                    if (userRole?.toLowerCase() === 'psychologist') {
                        ...
                        setDisplayedUser({
                            id: existingNotes.psychologistId,
                            name: existingNotes.psychologistName,
                            avatar: existingNotes.psychologistImageUrl || '/default-avatar.png'
                        });
                    }
